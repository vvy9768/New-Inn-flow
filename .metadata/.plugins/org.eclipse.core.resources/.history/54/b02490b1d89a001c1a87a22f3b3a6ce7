...
By profile_txt=By.cssSelector("div.position");
...
public void validateUserRoleText(String expText) {
	...
	utill.click(profile_txt, "User Profile ");
	
	utill.verifyText(profile_txt, expText);
}
